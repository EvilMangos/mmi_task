...
class TestConnection:
    ...
    @pytest.mark.asyncio
    async def test_start_is_idempotent(self, binance_settings: BinanceSettings) -> None:
...
class TestUrlConstruction:
    ...
    async def test_single_symbol_url_format(
        self, single_symbol_settings: BinanceSettings
    ) -> None:
...
class TestStopBehavior:
    ...
    @pytest.mark.asyncio
    async def test_stop_is_idempotent(self, binance_settings: BinanceSettings) -> None:
