...
class TestIsDebugEnabled:
    ...
    def test_is_debug_enabled_returns_true_for_1(
        self, monkeypatch: pytest.MonkeyPatch
    ) -> None:
    ...
    def test_is_debug_enabled_returns_true_for_true(
        self, monkeypatch: pytest.MonkeyPatch
    ) -> None:
    ...
    def test_is_debug_enabled_returns_true_for_yes(
        self, monkeypatch: pytest.MonkeyPatch
    ) -> None:
    ...
    def test_is_debug_enabled_case_insensitive(
        self, monkeypatch: pytest.MonkeyPatch
    ) -> None:
    ...
    def test_is_debug_enabled_returns_false_for_0(
        self, monkeypatch: pytest.MonkeyPatch
    ) -> None:
